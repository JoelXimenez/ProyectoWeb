...
<main class="contenido-panel">
    <div class="tarjeta">
        ...
        <c:if test="${not empty posturaDetallada}">
            ...
            <p><strong>Nombre en Sánscrito:</strong> <span>${posturaDetallada.nombreSanscrito}</span></p>
            <p><strong>Beneficios:</strong> <span>${posturaDetallada.beneficios}</span></p>
            <p><strong>Instrucciones:</strong> <span>${posturaDetallada.descripcion}</span></p>
