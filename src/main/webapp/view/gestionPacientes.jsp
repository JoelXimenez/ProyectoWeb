		...
		<div class="contenido-panel">
			<div class="tarjeta">
				<div class="header-gestion">
					...
					<a
						href="${pageContext.request.contextPath}/GestionarPacienteController?route=registrarPacienteFormulario"
					...
					<tbody>
						<c:forEach items="${pacientes}" var="paciente">
							<tr>
								...
								<td class="acciones-paciente"><a
									href="${pageContext.request.contextPath}/GestionarPacienteController?route=editarPaciente&id=${paciente.id}"
									class="btn btn-secundario">Editar</a> <a href="#"
									class="btn btn-secundario">Historial</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
