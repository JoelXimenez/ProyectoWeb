...
public class GestionarPosturasController extends HttpServlet {
    ...
    private boolean esAdministrador(HttpServletRequest req) {
        ...
        return session != null && session.getAttribute("administrador") != null;
    }
    ...
    private void listarPosturas(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            req.getRequestDispatcher("/view/gestionPosturas.jsp").forward(req, resp);
        } catch (Exception e) {
    ...
    private void mostrarFormularioNuevo(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/view/formularioPostura.jsp").forward(req, resp);
    }
    ...
    private Postura construirPosturaDesdeRequest(HttpServletRequest req) {
        ...
        // ⚠️ Nuevo: leer checkbox "activa"
        boolean activa = req.getParameter("activa") != null;
        ...
        postura.setActiva(activa); // ✅ Aquí seteamos la propiedad
